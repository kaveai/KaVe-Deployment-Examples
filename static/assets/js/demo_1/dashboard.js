(function ($) {
  ...
  $(function () {
    ...
    if ($('#total-transaction').length) {
      ...
      gradientStrokeFill_1.addColorStop(0, '#(function ($) {
  'use strict';
  $(function () {
    var lineStatsOptions = {
      scales: {
    ...
    if ($('#total-transaction').length) {
      ...
      var areaData = {
        ...
        datasets: [{
          ...
          borderColor: '#ef726f',
          borderWidth: 0,
          pointBackgroundColor: "#ef726f",
          pointRadius: 7,
          pointBorderWidth: 3,
          pointBorderColor: '#fff',
          pointHoverRadius: 7,
          pointHoverBackgroundColor: "#ef726f",
          pointHoverBorderColor: "#ef726f",
    ...
    if ($('#dashboard-guage-chart').length) {
      ...
      gradientStrokeFill_1.addColorStop(1, '#ef726f');
      var areaData = {
        labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun"],
        datasets: [{
          label: 'Sessions',
